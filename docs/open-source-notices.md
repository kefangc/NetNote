...
V1 使用或预留使用以下开源项目。正式提交作品时需在系统开发说明书中保留本表。
...
| pdfplumber | PDF 文本解析 | MIT, https://github.com/jsvine/pdfplumber |
| python-docx | DOCX 解析 | MIT, https://github.com/python-openxml/python-docx |
| python-pptx | PPTX 解析 | MIT, https://github.com/scanny/python-pptx |
| Pillow | 图片文件支持 | HPND, https://python-pillow.org |
| LangGraph | V2 多智能体编排 | MIT, https://www.langchain.com/langgraph |
